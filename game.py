...
class Game:
	...
	def update(self,delta):
		if self.state.is_player_dead(): self.state = StateLose(self.resolution, self.name, self.screen)
		if self.state.no_more_zombie(): self.state = StateWin (self.resolution, self.name, self.screen)
...
class StateGame:    
	...
	def __init_screen_objects(self,resolution,screen):
		...
		self.unitManager   = UnitManager(self.obj_on_screen,self.player, screen, resolution)
